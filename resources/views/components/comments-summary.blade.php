...
<div class="w-full p-2.5 border border-gray-300 shadow-sm bg-white dark:border-none dark:bg-neutral-900 rounded-md">
    ...
    <div class="lg:mt-2 lg:h-4/5 flex flex-col gap-2">
        ...
        <div class="p-3 border rounded-xl dark:border-gray-700">
            ...
            <div class="flex items-center gap-1">
                ...
                {{-- created_at --}}
                <span class="ml-auto">2025 Aug 12</span>
            </div>
            {{-- text --}}
            <div class="mt-2">
                <p>it to make a type specimen book. It has survived not only five centuries, but also the leap into electronic typesetting, remaining essentially unchanged. It was popularised in the 1960s with the release of Letraset sheets</p>
            </div>
        </div>
