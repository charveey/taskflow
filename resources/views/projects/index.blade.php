<x-app-layout>
    ...
    <div class="p-3 md:p-4 grid gap-3 grid-cols-1 md:grid-cols-2 lg:grid-cols-3 dark:text-neutral-50">
        ...
        {{-- projects --}}
        <a href="{{ route('projects.index') }}" class="block h-full rounded-2xl overflow-hidden shadow-sm">
            {{-- title --}}
            <div class="h-20 flex items-center justify-center bg-indigo-200 dark:bg-indigo-900">
                <p class="text-lg md:text-xl">Php project for this one</p>
            </div>
            <div class="p-3 flex flex-col gap-4 bg-white dark:bg-neutral-900">
                {{-- description --}}
                <p class="text-neutral-800 dark:text-neutral-100">Description:Php project for this one Php project for this one</p>
                {{-- progress bar --}}
                <div>
