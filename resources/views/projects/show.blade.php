            ...
            <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-3 md:gap-5 p-3 md:p-4 text-sm">
                ...
                <div class="space-y-3 md:space-y-4">
                    <div class="flex flex-row gap-3 md:gap-4">
                        <div class="w-full flex items-center gap-2 p-2.5 border border-gray-300 shadow-sm bg-white dark:border-none dark:bg-neutral-700 rounded-md">
                    ...
                    {{-- description --}}
                    <div class="min-h-28 flex items-start gap-3 p-2.5 border border-gray-300 shadow-sm bg-white dark:border-none dark:bg-neutral-700 rounded-md">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-5">
